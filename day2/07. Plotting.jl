...
begin
	...
	scatter!(num_pirates, global_temp, label= "plot")
end
...
begin
	xlabel!("Number of pirates (globally)")
	ylabel!("Global temperature (°C)")
	title!("Influence of pirate population on global warmning")
end
...
plotly()
#If you run it after running gr(), it won't work. So refresh then run this 
#plotly is very interactive - can see points, drag, zoom in etc 
...
@gif for i in 1:60 #number of frames 
	y = sin.(x .+ (i * 0.1)) # get y moving - braadcasting sin to x
